...
def png_plot_entry(image_path: Path, name: str) -> dict:
    """Base64-encode a saved PNG so it can ride in an ExperimentResult's "plots" list."""
    encoded = base64.b64encode(image_path.read_bytes()).decode("ascii")
    return {"name": name, "format": "png", "data": encoded}
